          ...
          <div className="bg-white rounded-xl w-full max-w-md shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              <div>
                ...
                <input type="text" value={name} onChange={(e) => setName(e.target.value)} required className="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" />
              </div>
              <ImageDropzone
                label="Logo"
