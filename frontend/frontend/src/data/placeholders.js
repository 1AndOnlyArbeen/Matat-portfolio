...
export const projectsData = [
  ...
  },
  {
    ...
    screenshots: [
      "https://images.unsplash.com/photo-1588702547919-26089e690ecc?w=1200&q=80",
...
export const appsData = [
  ...
  },
  {
    _id: "5",
    name: "HealthPulse",
    description: "Health monitoring app with heart rate tracking, sleep analysis, and wellness tips.",
    longDescription: "HealthPulse connects with wearable devices to monitor vital signs in real time. Features include heart rate monitoring, sleep pattern analysis, step counting, hydration reminders, and personalized wellness recommendations powered by AI.",
    icon: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=200&q=80",
    screenshots: [
  ...
  },
  {
    _id: "6",
    name: "BudgetBee",
    description: "Personal finance tracker with expense categorization, budgets, and savings goals.",
    longDescription: "BudgetBee helps users take control of their finances with automatic expense categorization, custom budget creation, savings goal tracking, bill reminders, and detailed spending reports with charts and insights.",
    icon: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=200&q=80",
    screenshots: [
  ...
  },
  {
    _id: "7",
    name: "TravelMate",
    description: "Travel planning app with itinerary builder, offline maps, and local recommendations.",
    longDescription: "TravelMate is the ultimate travel companion. Plan trips with smart itinerary suggestions, download maps for offline use, discover local restaurants and attractions, track expenses in multiple currencies, and share trips with friends.",
    icon: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=200&q=80",
    screenshots: [
  ...
  },
  {
    _id: "8",
    name: "CodeSnap",
    description: "Developer tool for creating beautiful code screenshots and sharing snippets.",
    longDescription: "CodeSnap lets developers create stunning code screenshots with syntax highlighting, custom themes, and export options. Share snippets via links, embed in blogs, and collaborate with team members on code reviews.",
    icon: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=200&q=80",
    screenshots: [
...
// gallery is grouped into albums — each album has a thumbnail (cover), place, date, and many images
export const galleryData = [
  {
    _id: "a1",
    place: "Kathmandu, Nepal",
    date: "2026-02-14",
    caption: "Development Workshop",
